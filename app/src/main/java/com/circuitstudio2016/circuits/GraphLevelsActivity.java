...
//    private Graph hg39 = this.parser.parse("");
    ...
    private Graph eg15 = this.parser.parse("I: Graph(11):\n" +
            ...
            "I: (9to10)\n" +
            "I: edone");
    private Graph eg16 = this.parser.parse("I: Graph(9):\n" +
            "I: (315, 1230)\n" +
            "I: (765, 1140)\n" +
            "I: (855, 600)\n" +
            "I: (225, 510)\n" +
    ...
    private Graph eg25 = this.parser.parse("I: Graph(12):\n" +
            ...
            "I: (9to10)\n" +
            "I: edone");
    private Graph eg26 = this.parser.parse("I: Graph(14):\n" +
            "I: (180, 1500)\n" +
            "I: (630, 1500)\n" +
            "I: (450, 1500)\n" +
            "I: (900, 1500)\n" +
            ...
            "I: (12to13)\n" +
            "I: edone");
    private Graph eg27 = this.parser.parse("I: Graph(15):\n" +
            "I: (360, 465)\n" +
            "I: (720, 555)\n" +
            "I: (720, 1005)\n" +
            "I: (450, 1365)\n" +
            ...
            "I: (9to13)\n" +
            "I: edone");
    private Graph eg28 = this.parser.parse("I: Graph(18):\n" +
            "I: (180, 1500)\n" +
            "I: (360, 1320)\n" +
            "I: (540, 1140)\n" +
            "I: (720, 960)\n" +
            ...
            "I: (15to17)\n" +
            "I: edone");
    private Graph eg29 = this.parser.parse("I: Graph(18):\n" +
            "I: (180, 1500)\n" +
            "I: (360, 1320)\n" +
            "I: (540, 1140)\n" +
            "I: (720, 960)\n" +
            ...
            "I: (15to17)\n" +
            "I: edone");
    private Graph eg30 = this.parser.parse("I: Graph(19):\n" +
            "I: (360, 1147)\n" +
            "I: (630, 1147)\n" +
            "I: (900, 1147)\n" +
            "I: (540, 1507)\n" +
